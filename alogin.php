			...
			<div class="row main">
				...
				<div class="main-login main-center">
					<form class="form-horizontal" method="POST" action="#">
						...
						<div class="form-group ">
							<input type="submit" class="btn btn-primary btn-lg btn-block login-button" name="SUB" value="Login" style="font-weight:bold">
						</div>
...
$passwor=$_POST['pass'];
echo $passwor;
$sql="SELECT * FROM alogin WHERE name='$username' AND password='$passwor'";
